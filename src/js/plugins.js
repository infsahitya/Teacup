...
darkmodebtn.addEventListener("click", function () {
    if (web_body.className == "light") {
        ...
        home_container.style.backgroundImage = "url('assets/img/home/dark-background.jpg')";
        home_container.style.backgroundPosition = "center";
    }
    else {
        web_body.className = "light";
        home_container.style.backgroundImage = "url('assets/img/home/light-background.jpg')";
